...
function Nav() {
  return (
    <div className='w-full h-[80px] bg-gradient-to-t from-blue-900 to-black fixed bottom-0 md:top-0 text-white flex justify-around  md:justify-center items-center gap-[50px] p-[20px] z-30 '>
      <Link to={"/"}>
